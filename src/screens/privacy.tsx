...
export function Privacy() {
  return (
    <Container pt="7.5rem" pb="8" sx={sxProp}>
      ...
      <p>
        STOICA GEORGE OVIDIU PFA ("us", "we", or "our") operates the{' '}
        <a href="https://designvote.io">designvote.io</a> website (hereinafter
      ...
      <p>
        ...
        <a href="https://designvote.io">designvote.io</a>
      </p>
      <h2>Definitions</h2>
      <ul>
        <li>
          ...
          <p>
            Service is the <a href="https://designvote.io">designvote.io</a>{' '}
            website operated by STOICA GEORGE OVIDIU PFA
          </p>
        </li>
        <li>
          <p>
      ...
      <h2>Use of Data</h2>
      <p>Designvote uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are from the European Economic Area (EEA), Designvote legal basis
      ...
      <p>Designvote may process your Personal Data because:</p>
      <ul>
      ...
      <p>
        Designvote will retain your Personal Data only for as long as is
      ...
      <p>
        Designvote will also retain Usage Data for internal analysis purposes.
      ...
      <p>
        Designvote will take all the steps reasonably necessary to ensure that
      ...
      <p>
        If Designvote is involved in a merger, acquisition or asset sale, your
      ...
      <p>
        Under certain circumstances, Designvote may be required to disclose your
        Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3>Legal Requirements</h3>
      <p>
        Designvote may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Designvote</li>
        <li>
      ...
      <p>
        ...
        certain data protection rights. Designvote aims to take reasonable steps
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            right to withdraw your consent at any time where Designvote relied
      ...
      <p>
        Your authentication information is provided directly to our third-party
        authentication processors whose use of your personal information is
        governed by their Privacy Policy.
      </p>
      <p>The authentication processors we work with are:</p>
      <ul>
        <li>
          <p>
            <strong>
      ...
      <ul>
        <li>
          By email:{' '}
          <a href="mailto:ovidiu.stoica1094@gmail.com">contact@designvote.io</a>
        </li>
      </ul>
    </Container>
  )
