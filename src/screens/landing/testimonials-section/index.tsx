...
import {Box, Button, Grid, Heading, Text, SlideFade} from '@chakra-ui/react'
        ...
        >
          ...
          >
            <Box>
              ...
              <Text mt="4">
                Many creators and designers waste lots of time asking directly
                for feedback and gathering all the results manually.
              </Text>
              <Button
                ref={buttonRef}
                colorScheme="orange"
