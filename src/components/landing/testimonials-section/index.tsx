    ...
    >
      ...
      >
        ...
        <Box maxW={{base: 'unset', lg: '37.5rem'}} mx="auto">
          ...
          >
            &ldquo;We were wasting too much time getting feedback on our mobile
            app design versions from costumers and colleagues. With Designvote
            we were able to create and share surveys that solved this issue
            immediately.&ldquo;
          </Testimonial>
        </Box>
      </Grid>
