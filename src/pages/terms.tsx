...
const sxProp: any = {
  ...
  h2: {fontWeight: 'semibold', marginTop: '1rem'},
  h3: {fontWeight: 'semibold', marginTop: '1rem'},
  h4: {fontWeight: 'semibold', marginTop: '1rem'},
  p: {marginTop: '.5rem'},
}
export function Terms() {
  return (
    <>
      ...
      <Container sx={sxProp} pt="7.5rem" pb="8">
        ...
        <p>
          ...
          <a href="https://designvote.io">designvote.io</a> website (the
          "Service") operated by STOICA GEORGE OVIDIU PFA("us", "we", or "our").
        </p>
        <p>
        ...
        <p>
          ...
          Designvote cancels it. You may cancel your Subscription renewal either
          through your online account management page or by contacting
          Designvote customer support team.
        </p>
        <p>
          ...
          Designvote with accurate and complete billing information including
          ...
          you automatically authorize Designvote to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, Designvote will
        ...
        <h2>Free Trial</h2>
        <p>
          Designvote may, at its sole discretion, offer a Subscription with a
        ...
        <p>
          ...
          Trial, you will not be charged by Designvote until the Free Trial has
        ...
        <p>
          At any time and without notice, Designvote reserves the right to (i)
          modify the terms and conditions of the Free Trial offer, or (ii)
          cancel such Free Trial offer.
        </p>
        <h2>Fee Changes</h2>
        <p>
          Designvote, in its sole discretion and at any time, may modify the
        ...
        <p>
          Designvote will provide you with a reasonable prior notice of any
        ...
        <p>
          ...
          Designvote on a case-by-case basis and granted in sole discretion of
          Designvote.
        </p>
        <h2>Content</h2>
        <p>
        ...
        <p>
          ...
          "Copyright Infringement" of dmca@Designvotetheweb.com and include in
        ...
        <p>
          ...
          property of Designvote and its licensors. The Service is protected by
          copyright, trademark, and other laws of both Europe (Denmark) and
          foreign countries. Our trademarks and trade dress may not be used in
          connection with any product or service without the prior written
          consent of Designvote.
        </p>
        <h2>Links To Other Web Sites</h2>
        <p>
          Our Service may contain links to third-party web sites or services
          that are not owned or controlled by Designvote.
        </p>
        <p>
          Designvote has no control over, and assumes no responsibility for, the
          content, privacy policies, or practices of any third party web sites
          or services. You further acknowledge and agree that Designvote shall
        ...
        <p>
          In no event shall Designvote, nor its directors, employees, partners,
        ...
        <p>
          Designvote its subsidiaries, affiliates, and its licensors do not
        ...
        <p>
          ...
          laws of Europe (Denmark), without regard to its conflict of law
          provisions.
        </p>
        <p>
