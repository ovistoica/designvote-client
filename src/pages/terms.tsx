  ...
  return (
    <Container sx={sxProp} pt="7.5rem" pb="8">
      ...
      <p>
        ...
        renew under the exact same conditions unless you cancel it or Designvote
        cancels it. You may cancel your Subscription renewal either through your
        online account management page or by contacting Designvote customer
        support team.
      </p>
      <p>
        A valid payment method, including credit card or PayPal, is required to
        process the payment for your Subscription. You shall provide Designvote
        ...
        authorize Designvote to charge all Subscription fees incurred through
      ...
      <h2>Free Trial</h2>
      <p>
        Designvote may, at its sole discretion, offer a Subscription with a free
      ...
      <p>
        Designvote will provide you with a reasonable prior notice of any change
      ...
      <p>
        ...
        are not owned or controlled by Designvote.
      </p>
      <p>
        Designvote has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that Designvote shall not be
      ...
      <p>
        ...
        of Europe (Denmark), without regard to its conflict of law provisions.
      </p>
      <p>
