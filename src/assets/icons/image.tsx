...
export const HangedImage = createIcon({
  displayName: 'HangedImage',
  viewBox: '0 0 50 62',
  path: (
    <>
      <path
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M7 21.676L25 1M43.629 22.335l-19-21" stroke="currentColor" />
      <circle cx={25} cy={3} r={1.5} fill="#EEF3F4" stroke="currentColor" />
    </>
  ),
})
